...
import pandas as pd
import pytest
from src.dashboard.app import estimate_ftp, normalized_power, compute_tss, human_duration

def test_human_duration():
    assert human_duration(3661) == "1h 1m 1s" or "1h1m1s"  # depending du formatting, accepte présence d'unités
